...
def build_llm_prompt(
    ...
    return (
        ...
        "7. 不要混用不同年度或期別的資訊；若問題指定 114 或 115，只回答該期。\n"
        "8. 若問題未指定期別，且知識庫同時有 114 年第 01 期與 115 年第 02 期資料，請同時整理兩期答案，避免只引用單一期別。\n"
        "9. 本系統只服務職前訓練課程；若使用者詢問在職訓練或在職補助，請簡短說明不在本系統回答範圍，並引導改問職前補助、報名資格或青年獎勵金。\n"
        "10. 來源與注意事項由系統畫面另行呈現，回答正文不要自行加入「來源依據」或「注意事項」標題。\n\n"
        f"使用者問題：{question}\n"
